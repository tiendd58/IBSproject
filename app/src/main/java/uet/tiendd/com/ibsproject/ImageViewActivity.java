...
public class ImageViewActivity extends FragmentActivity {
    ...
    private IARegion.Listener mRegionListener = new IARegion.Listener() {
        ...
        public void onEnterRegion(IARegion region) {
            if (region.getType() == IARegion.TYPE_FLOOR_PLAN) {
                ...
                Log.d(TAG, "floor plan changed to " + id);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mbtnShow = (Button) findViewById(R.id.btn_magnetic);
        ...
        Toast.makeText(this, "hello "+floorPlanId, Toast.LENGTH_LONG).show();
        ...
        mbtnShow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(ImageViewActivity.this, "location is: " + longitude + " " + latitude, Toast.LENGTH_SHORT).show();
            }
        });
    }
            ...
            mPendingAsyncResult.setCallback(new IAResultCallback<IAFloorPlan>() {
                ...
                public void onResult(IAResult<IAFloorPlan> result) {
                    ...
                    if (result.isSuccess() && result.getResult() != null) {
                        ...
                        String filePath = Environment.getExternalStorageDirectory().getPath() + "/IBS/" + fileName;
